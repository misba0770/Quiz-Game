...
public class QuizGame implements ActionListener {
    ...
    String[][] options={
                     ...
                     {"1989","1996","1972","1492"},
                     {"Apple","Kotlin","Oak","C"},
                      {"Steve Jobs","Bill Gates","James Gostling","Mark Zuckerburg"},
                      {"Sequence-dependent language","Code dependent language","Platform-dependent language","Platform-independent language"}
                       };
    char[] answers={
                    'A',
                    'B',
